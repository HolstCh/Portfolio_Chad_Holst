        ...
        <div className="photo-gallery projects-text">
            <div className="relative">
                ...
                <div className="flex items-center justify-center">
                    <button
                        className="md:mx-8 mx-3 mb-4 inline-flex text-white bg-blue-600 border-0 py-2 px-6 focus:outline-none hover:bg-blue-400 hover:text-slate-800 rounded text-l"
                        onClick={prevImage}
                    >
                        &lt;
                    </button>
